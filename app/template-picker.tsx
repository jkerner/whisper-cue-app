...
const TEMPLATES: Template[] = [
  {
    id: "power-vinyasa-60",
    name: "Power Vinyasa",
    subtitle: "Strength, flow, and heat",
    duration: "60 MIN",
    level: "ALL LEVELS",
    sections: ["Integration", "Warm-Up", "Sun Salutations", "Standing Series", "Peak Poses", "Cool Down", "Savasana + Close"],
  },
  {
    id: "power-vinyasa-90",
    name: "Power Vinyasa",
    subtitle: "Extended peak & deep cool down",
    duration: "90 MIN",
    level: "INTERMEDIATE",
    sections: ["Integration", "Warm-Up", "Sun Salutations A", "Sun Salutations B", "Standing Series", "Peak Poses", "Hip Openers", "Backbends", "Cool Down", "Savasana + Close"],
  },
  {
    id: "yin-75",
    name: "Yin Yoga",
    subtitle: "Slow, deep, and meditative",
    duration: "75 MIN",
    level: "ALL LEVELS",
  ...
  },
  {
    id: "beginner-45",
    name: "Beginner Flow",
    subtitle: "Foundational poses and alignment",
    duration: "45 MIN",
    level: "BEGINNER",
  ...
  },
  {
    id: "restorative-60",
    name: "Restorative",
    subtitle: "Rest, release, and renew",
    duration: "60 MIN",
    level: "ALL LEVELS",
